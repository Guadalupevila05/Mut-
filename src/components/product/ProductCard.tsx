...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const isFresh =
  product.postedDaysAgo !== undefined && product.postedDaysAgo <= 1;
  return (
    <motion.div
      initial={{
        opacity: 0,
      ...
      <div className="mt-4 px-1">
        <div className="flex justify-between items-baseline gap-2 mb-1">
          ...
          <span className="inline-flex items-center gap-0.5 text-[10px] font-medium text-ink/50 dark:text-warmWhite/50 shrink-0">
              <MapPinIcon size={10} />
